...
SECRET_KEY = 'django-insecure-7dajjw1zd6pn8kk3d=+7hproh*ow^(5#c340x51ew_pci0x&r$'
...
INSTALLED_APPS = [
    ...
    'faceapp.apps.FaceappConfig',  # Your custom app
...
ROOT_URLCONF = 'face_recognition_admin.urls'
...
# WSGI for regular HTTP requests
WSGI_APPLICATION = 'face_recognition_admin.wsgi.application'
